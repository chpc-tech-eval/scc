...
<span id="fig1" class="img_container center" style="font-size:8px;margin-bottom:20px; display: block;">
    <img alt="./resources/browsing_internet_dark.png" src="./resources/browsing_internet_dark.png" style="display:block; margin-left: auto; margin-right: auto;" title="caption" />
