...
Quantum computing is an interdisciplinary field within Computer Science and Quantum physics 

Quantum physics serves to resolve problems such as complex database searches and machine learning 

Quantum physics is the study of subatomic particles and their characteristics 

Quantum circuits use logic gates known as Hadamard gates  (|H|-) which superpositions(exists together simultaneously ) qubits (|0> and/or |1>) in order to resolve complex problems within fields such as machine learning and complex database searches

In order for Quantum computing to be feasible we need to ensure that there needs to be an absence of atmospheric pressure and temperature needs to be absolute zero.

The following image shows the difference between Quantum computing and traditional computing
![image](https://research-assets.cbinsights.com/2020/12/22124918/Quantum_computing_classical_qubit_infographic_122020.png)

The following image shows the qubit and explains more about it
![image](https://physics.aps.org/assets/6324ce0e-cf71-412c-b76d-a169a9170dae/e35_1.png)

Mathematical representation of a qubit
![image](https://universe-review.ca/I13-11-qbit.jpg)

Qiskit: What is it and how is it related to quantum computing

Qiskit is a software development kit in order to facilitate the design of quantum 

It was developed by the quantum computing team at IBM and is written in the  Python programming language

For more information,

see the main website for Qiskit

(https://www.ibm.com/quantum/qiskit)

blogs on Qiskit and Quantum computing in general
(https://www.energy.gov/science/doe-explainsquantum-computing)

Googles discovery of quantum error correction
(https://blog.google/technology/google-deepmind/alphaqubit-quantum-error-correction/#:~:text=Quantum%20computers%20harness%20the%20unique,fewer%20steps%20than%20classical%20computers.)

(https://aws.amazon.com/what-is/quantum-computing/#:~:text=Quantum%20computation%20has%20the%20potential,software%20to%20run%20chemistry%20simulations.)
