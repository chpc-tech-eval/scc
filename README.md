...
- [CHPC 2024 Student Cluster Competition](#chpc-2024-student-cluster-competition)
- [Table of Contents](#table-of-contents)
- [Structure of the Competition](#structure-of-the-competition)
  - [Getting Help](#getting-help)
    - [GitHub Discussions Page](#github-discussions-page)
    - [GitHub Issues Page](#github-issues-page)
    - [Using Chat GPT4](#using-chat-gpt4)
  - [Timetable](#timetable)
  - [Scoring](#scoring)
  - [Instructions for Mentors](#instructions-for-mentors)
    - [Hands-Off Rule *(You may not touch the keyboard)*](#hands-off-rule-you-may-not-touch-the-keyboard)
  - [Cheat Sheet](#cheat-sheet)
- [Deliverables](#deliverables)
  - [Project](#project)
  - [Technical Knowledge Assessment](#technical-knowledge-assessment)
- [Links to Livestreams and Lecture Recordings](#links-to-livestreams-and-lecture-recordings)
  - [Day 1 - Welcome, Introduction and Getting Started](#day-1---welcome-introduction-and-getting-started)
  - [Day 2 - HPC Hardware, HPC Networking and Systems Administration](#day-2---hpc-hardware-hpc-networking-and-systems-administration)
  - [Day 3 - Benchmarking, Compilation and Parallel Computing](#day-3---benchmarking-compilation-and-parallel-computing)
  - [Day 4 - HPC Administration and Application Visualization](#day-4---hpc-administration-and-application-visualization)
  - [Day 5 - Career Guidance](#day-5---career-guidance)
- [Tutorial Glossary and Section Overview](#tutorial-glossary-and-section-overview)
  - [Tutorial 1](#tutorial-1)
  - [Tutorial 2](#tutorial-2)
  - [Tutorial 3](#tutorial-3)
  - [Tutorial 4](#tutorial-4)
- [Contributing to the Project](#contributing-to-the-project)
  - [Steps to follow when editing existing content](#steps-to-follow-when-editing-existing-content)
  - [Syntax and Style](#syntax-and-style)
- [Collaborating with your Team and Storing you Progress on GitHub](#collaborating-with-your-team-and-storing-you-progress-on-github)
  - [Forking the Tutorials into Your Own Team's Private GitHub Repository](#forking-the-tutorials-into-your-own-teams-private-github-repository)
  - [Editing the Git Markdown Files to Track Your Team's Progress](#editing-the-git-markdown-files-to-track-your-teams-progress)
...
2. [Understanding the Roles of the Head Node and Compute Nodes](tutorial2/README.md#understanding-the-roles-of-the-head-node-and-compute-nodes)
   1. [Basic System Monitoring](tutorial2/README.md#basic-system-monitoring)
   2. [Terminal Multiplexers](tutorial2/README.md#terminal-multiplexers)
3. [Manipulating Files and Directories](tutorial2/README.md#manipulating-files-and-directories)
    1. [List Directory `ls`](tutorial2/README.md#list-directory-ls)
    2. [Change Directory `cd`](tutorial2/README.md#change-directory-cd)
    3. [Copy File or Directory `cp`](tutorial2/README.md#copy-file-or-directory-cp)
    4. [Move File or Directory `mv`](tutorial2/README.md#move-file-or-directory-mv)
    5. [Make a New Directory `mkdir`](tutorial2/README.md#make-a-new-directory-mkdir)
    6. [Remove File or Directory `rm`](tutorial2/README.md#remove-file-or-directory-rm)
    7. [Recommended Project Folder Structure](tutorial2/README.md#recommended-project-folder-structure)
4. [Verifying Networking Setup](tutorial2/README.md#verifying-networking-setup)
    1. [Head Node](tutorial2/README.md#head-node)
    2. [Compute Node](tutorial2/README.md#compute-node)
    3. [Editing `/etc/hosts` File](tutorial2/README.md#editing-etchosts-file)
    4. [Permanent `~/.ssh/config` Configuration](tutorial2/README.md#permanent-sshconfig-configuration)
5. [Configuring a Simple Stateful Firewall](tutorial2/README.md#configuring-a-simple-stateful-firewall)
    1. [IPTables](tutorial2/README.md#iptables)
    2. [NFTables](tutorial2/README.md#nftables)
    3. [Front-end Firewall Application Managers](tutorial2/README.md#front-end-firewall-application-managers)
6. [Network Time Protocol](tutorial2/README.md#network-time-protocol)
    1. [NTP Server (Head Node)](tutorial2/README.md#ntp-server-head-node)
    2. [NTP Client (Compute Node)](tutorial2/README.md#ntp-client-compute-node)
7. [Network File System](tutorial2/README.md#network-file-system)
    1. [NFS Server (Head Node)](tutorial2/README.md#nfs-server-head-node)
    2. [NFS Client (Compute Node)](tutorial2/README.md#nfs-client-compute-node)
        1. [Mounting An NFS Mount](tutorial2/README.md#mounting-an-nfs-mount)
        2. [Making The NFS Mount Permanent](tutorial2/README.md#making-the-nfs-mount-permanent)
    3. [Passwordless SSH](tutorial2/README.md#passwordless-ssh)
        1. [Generating SSH Keys on Your Head Node](tutorial2/README.md#generating-ssh-keys-on-your-head-node) 
        2. [Understanding `~/.ssh/authorized_keys`](tutorial2/README.md#understanding-ssh/authorized_keys)
        3. [User Permissions and Ownership](tutorial2/README.md#user-permissions-and-ownership)
8. [User Account Management](tutorial2/README.md#user-account-management)
    1. [Create Team Captain User Account](tutorial2/README.md#create-team-captain-user-account)
        ...
        2. [Compute Node](tutorial2/README.md#compute-node-1)
        3. [Super User Access](tutorial2/README.md#super-user-access)
    2. [Out-Of-Sync Users and Groups](tutorial2/README.md#out-of-sync-users-and-groups)
        1. [Head Node](tutorial2/README.md#head-node-2)
        2. [Compute Node](tutorial2/README.md#compute-node-2)
        3. [Clean Up](tutorial2/README.md#clean-up)
    3. [Ansible User Declaration](tutorial2/README.md#ansible-user-declaration)
        1. [Installing and Configuring Ansible](tutorial2/README.md#installing-and-configuring-ansible)
        2. [Create Team Member Accounts](tutorial2/README.md#create-team-member-accounts)
9. [Remote Access to Your Cluster and Tunneling](tutorial2/README.md#remote-access-to-your-cluster-and-tunneling)
    1. [Local Port Forwarding](tutorial2/README.md#local-port-forwarding)
    2. [Dynamic Port Forwarding](tutorial2/README.md#dynamic-port-forwarding)
        1. [Web Browser and SOCKS5 Proxy Configuration](tutorial2/README.md#web-browser-and-socks5-proxy-configuration)
    3. [WirGuard VPN Cluster Access](tutorial2/README.md#wirguard-vpn-cluster-access)
    4. [ZeroTier](tutorial2/README.md#zerotier)
    5. [X11 Forwarding](tutorial2/README.md#x111-forwarding)
