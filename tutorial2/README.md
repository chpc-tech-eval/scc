...
1. [refresh changes ](#refresh-changes)
...
1. [Allow root to run any commands anywhere](#allow-root-to-run-any-commands-anywhere)
1. [Allows members of the 'sys' group to run networking, software,](#allows-members-of-the-sys-group-to-run-networking-software)
1. [service management apps and more.](#service-management-apps-and-more)
1. [Allows people in group wheel to run all commands without a password](#allows-people-in-group-wheel-to-run-all-commands-without-a-password)
    1. [-](#-)
...
1. [Ansible User Declaration](#ansible-user-declaration)
    ...
    1. [# add the below content](#-add-the-below-content)
    1. [# create user team_lead, execute tasks to grand sudo priviledge ](#-create-user-team_lead-execute-tasks-to-grand-sudo-priviledge)
